...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  t = t_init;
  mu = 0.575;
  un(1:n,1) = u_init (mu,x,t);
  un(1,1) = u_a (mu,x(1),t);
  un(n,1) = u_b (mu,x(end),t);
...
%
  ua = mu*abs(sin(2*x))+0.1;
  return
end

function ub = u_b (mu,x,t)
...
%
  ub = mu*abs(sin(2*x))+0.1;

  return
end

function u = u_init (mu,x,t)
